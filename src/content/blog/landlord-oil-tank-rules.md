---
title: "Landlord Oil Tank Responsibility: What Rental Property Owners Are On the Hook For"
navTitle: "Landlord Oil Tank"
metaTitle: "Landlord Oil Tank Responsibility in NB: A Full Guide"
metaDescription: "What landlords in Moncton and Southeast NB are on the hook for with oil tanks: insurance rules, tenant issues, replacement costs, and when to call a pro."
primaryKeyword: "landlord oil tank responsibility"
secondaryKeywords: "oil tank rules for rental properties, who pays for oil tank replacement in a rental, landlord oil tank insurance requirements, rental property oil tank NB, landlord heating obligations New Brunswick"
publishedDate: "2026-08-23"
tag: "Regulations"
subtitle: "Your tenant calls at 9 pm on a Friday. The basement smells like diesel and the furnace just quit. Whose problem is that? Yours. All of it."
canonical: "https://hubcitytank.ca/blog/landlord-oil-tank-rules/"
faq:
  - question: "Who pays for oil tank replacement in a rental, the landlord or the tenant?"
    answer: "The landlord does. The tank is part of the building's heating equipment, just like the furnace, so buying, maintaining, and replacing it is the owner's cost. Tenants typically pay only for the heating oil itself, and only if the lease sets it up that way."
  - question: "Can my insurer really refuse to cover my rental because of the oil tank's age?"
    answer: "Yes, and it happens all the time in Southeast New Brunswick. Most insurers want proof the tank is under a set age, often 15 to 25 years, and missing paperwork usually gets treated the same as too old. Replacing an undocumented tank is almost always cheaper than shopping for high-risk coverage."
  - question: "What if my tenant lets the tank run dry in the middle of winter?"
    answer: "You still need to restore heat quickly, because habitability is the landlord's obligation even when the tenant caused the outage. A run-out often means bleeding the line, and sometimes a clogged filter from stirred-up sludge. Prevent it with a lease clause requiring a minimum oil level, or set up automatic delivery so it never happens."
  - question: "Do I have to remove an old unused tank at my rental property?"
    answer: "If it's disconnected and empty, removal isn't always legally required right away, but leaving it is rarely worth it. Old tanks can still hold residual oil, insurers flag them, and buyers will demand proof of proper removal when you sell. Have it taken out, keep the paperwork, and the problem is gone for good."
---
...
In New Brunswick, a landlord has to keep a rental fit to live in, and in this climate that means dependable heat. If the building heats with oil, then the furnace, the oil line, the filter, and the tank itself are all part of the premises. They're your equipment, your maintenance job, and your liability. The [Residential Tenancies Tribunal](https://www2.snb.ca/content/snb/en/sites/rent.html) is where disputes end up when heat fails and nobody fixes it.
...
The lesson from Marc's story is that the tank's paperwork matters almost as much as the tank. Keep the installation certificate, the invoice, and photos of the nameplate in your rental file. We've covered how insurers judge tank age in [oil tank age and insurance](/blog/oil-tank-age-insurance/), and what actually gets paid out in [does insurance cover oil tank leaks](/blog/does-insurance-cover-oil-tank-leaks/). Short version: a leak from a tank you neglected is very often not covered at all.
...
Heather's tank looked fine from the driveway, by the way. Steel tanks almost always rust from the inside out, so a tank that "looks okay" means very little. Our [oil tank inspection checklist](/blog/oil-tank-inspection-checklist/) walks you through the six spots to actually check twice a year, and it takes about fifteen minutes.
